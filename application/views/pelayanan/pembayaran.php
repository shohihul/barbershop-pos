  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td><?= $harga ?></td>
                <td>
                  <button href="#" data-href="<?= site_url('pelayanan/hapus_layanan') ?>" data-id="<?= $pel['id_pelayanan'] ?>" data-redirect="<?= site_url('pelayanan/pembayaran/' . $id_kunjungan . '') ?>" class="btn btn-danger btn-sm tombol-hapus">Hapus</button>
                </td>
              </tr>
      ...
      <div class="d-flex justify-content-center mt-4 ">
        ...
        <?php else : ?>
          <form action="<?= site_url('pelayanan/bayar') ?>" method="POST">
            <input type="hidden" name="url" id="url" value="pelayanan/pembayaran/<?= $id_kunjungan ?>">
            ...
            <div class="text-center mb-3">
              <input type="text" class="form-control" id="bayar" name="bayar" aria-describedby="bayarHelp" autocomplete="off">
              <small id="bayarHelp" class="form-text text-muted">Masukkan pembayaran hanya berupa angka!</small>
            </div>
            <button type="submit" class="btn btn-success" style="width: 400px;">Bayar</button>
          </form>
        <?php endif; ?>
      </div>
    </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="form-layanan" action="<?= site_url('pelayanan/add_jasa') ?>" method="POST">
          <?php $urll = 'pelayanan/pembayaran/' . $id_kunjungan . ''; ?>
