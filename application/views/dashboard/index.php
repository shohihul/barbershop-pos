...
<div class="container-fluid">
  ...
  <div class="row">
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <div class="h5 mb-0 font-weight-bold text-gray-800">Rp<?= $todayEarnings ?></div>
            </div>
            <div class="col-auto">
    ...
    <!-- Earnings (Monthly) Card Example -->
    <?php $target = ($customerTarget / 400 * 100) ?>
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-info shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Customer (Target)</div>
              <div class="row no-gutters align-items-center">
                <div class="col-auto">
                  <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?= $customerTarget ?>/400</div>
                </div>
                <div class="col">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-warning shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Customers in Queue</div>
              <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $customerInQueue ?></div>
            </div>
            <div class="col-auto">
...
<!-- End of Main Content -->
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; 9 Cahaya 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
      ...
      <script src="<?= base_url() ?>public/js/script-v2.js"></script>
        ...
        var myLineChart = new Chart(ctx, {
          ...
          data: {
            labels: [
              ...
              "Tgl 6", "Tgl 7", "Tgl 8", "Tgl 9", "Tgl 10",
              "Tgl 11", "Tgl 12", "Tgl 13", "Tgl 14", "Tgl 15",
              "Tgl 16", "Tgl 17", "Tgl 18", "Tgl 19", "Tgl 20",
